...
a persistence unit "pruebaConsumoDeudasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaConsumoDeudas/pom.xml":
...
artifact ("pruebaConsumoDeudas.war") is already built. You can build
